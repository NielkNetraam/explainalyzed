...
_get_lineage_scenarios = {
    ...
    "IF select_2 THEN success": (
        "select_2",
        {
            ...
            "sample_table.name -- COLUMN --> target.upper(name)",
        },
    ),
    ...
    "IF explode THEN success": (
        "explode",
        {
            "sample_table.age -- COLUMN --> target.age",
            "sample_table.age -- FILTER --> target.age",
            "sample_table.age -- GROUP_BY --> target.age",
            "sample_table.name -- FILTER --> target.age",
            "sample_table.age -- COLUMN --> target.key",
            "sample_table.name -- COLUMN --> target.key",
            "sample_table.name -- FILTER --> target.key",
            "sample_table.age -- FILTER --> target.key",
            "sample_table.age -- GROUP_BY --> target.key",
            "sample_table.age -- COLUMN --> target.m",
            "sample_table.name -- COLUMN --> target.m",
            "sample_table.name -- FILTER --> target.m",
            "sample_table.age -- FILTER --> target.m",
            "sample_table.age -- GROUP_BY --> target.m",
            "sample_table.name -- COLUMN --> target.names",
            "sample_table.age -- GROUP_BY --> target.names",
            "sample_table.name -- FILTER --> target.names",
            "sample_table.age -- FILTER --> target.names",
            "sample_table.age -- FILTER --> target.names_upper",
            "sample_table.name -- FILTER --> target.names_upper",
            "sample_table.name -- COLUMN --> target.names_upper",
            "sample_table.name -- COLUMN --> target.names_upper2",
            "sample_table.age -- GROUP_BY --> target.names_upper",
            "sample_table.age -- GROUP_BY --> target.names_upper2",
            "sample_table.name -- FILTER --> target.names_upper2",
            "sample_table.age -- FILTER --> target.names_upper2",
            "sample_table.age -- FILTER --> target.new_name",
            "sample_table.age -- GROUP_BY --> target.new_name",
            "sample_table.name -- FILTER --> target.new_name",
            "sample_table.name -- COLUMN --> target.new_name",
            "sample_table.name -- COLUMN --> target.value",
            "sample_table.name -- FILTER --> target.value",
            "sample_table.age -- COLUMN --> target.value",
            "sample_table.age -- GROUP_BY --> target.value",
            "sample_table.age -- FILTER --> target.value",
        },
    ),
}
